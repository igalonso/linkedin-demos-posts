...
products =[{"name":"iPhone 15 Pro","image":"imgs/iphone.png", "description":"The iPhone 15 Pro is the best iPhone ever. It has a 6.7 inch screen, 5G, and a 120Hz refresh rate. It also has a 50MP camera, 8K video recording, and a 5000mAh battery."},{"name":"Samsung Galaxy S23 Ultra","image":"imgs/samsung.png", "description":"The Samsung Galaxy S23 Ultra is a flagship Android smartphone unveiled in February 2023. It boasts a powerful processor, a versatile camera system, and a large, high-resolution display."},{"name":"Google Pixel 8 Pro","image":"imgs/google.png", "description":"The Google Pixel 8 Pro is a flagship Android smartphone It boasts a powerful processor, a versatile camera system, and a large, high-resolution display."}]
...
with col1:
    ...
    if st.button("Create campaign tweet"):
        ...
        with col3:
            ...
            app.generate_photo("Easy Mobile", "@easy_mobile_shop", tweet["body"], tweet["hashtags"], tweet["link"], "user_photo.png", "output.png")
            st.image("output_tweet.png", width=400)
